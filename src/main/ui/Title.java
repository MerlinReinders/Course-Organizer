...
// Course organizer application title
public class Title extends Component {

    public Title(OrganizerAppDisplay organizerAppDisplay, JComponent parent, int x, int y, String labelMessage) {
    ...
    protected void createComponent() {
        ...
        component.setFont(new Font(Font.SANS_SERIF, Font.BOLD, 22));
